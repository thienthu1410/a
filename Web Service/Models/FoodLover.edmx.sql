...
GO
USE [db47602c168625441c9c68a6d100f9ef5d];
GO
...
insert LoaiMon(TenLoaiMon) values (N'Ăn Sáng')
insert LoaiMon(TenLoaiMon) values (N'Món Chính')
insert LoaiMon(TenLoaiMon) values (N'Tráng Miệng')

insert MucDo(TenMucDo) values (N'Dễ')
insert MucDo(TenMucDo) values (N'Trung Bình')
insert MucDo(TenMucDo) values (N'Khó')
